(() => {
          ...
          <div class="svcPanel__inner">
            ...
            <div class="svcPanel__right">
              ...
              <div class="svcServices is-active" data-svc-services="startup">
                ...
                <div class="svcItems">
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:0"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Proprietorship</span><span class="svcItem__desc">Best for individual business owners and freelancers.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:1"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Partnership Firm</span><span class="svcItem__desc">Ideal for businesses operated by two or more partners.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:2"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">One Person Company (OPC)</span><span class="svcItem__desc">Limited liability business structure for a single owner.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:3"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Limited Liability Partnership (LLP)</span><span class="svcItem__desc">Flexible business structure with legal protection for partners.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:4"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Private Limited Company</span><span class="svcItem__desc">Most popular startup structure for growth and fundraising.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:5"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Public Limited Company</span><span class="svcItem__desc">Suitable for large businesses seeking expansion.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:6"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Section 8 Company</span><span class="svcItem__desc">Non-profit company structure for social and charitable activities.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:7"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Producer Company</span><span class="svcItem__desc">Designed for agricultural producers and farmer groups.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:8"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Trust Registration</span><span class="svcItem__desc">Legal structure for charitable and religious organizations.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:9"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Indian Subsidiary Company</span><span class="svcItem__desc">For foreign businesses establishing operations in India.</span></span><span class="svcItem__arr">→</span></a>
                </div>
              </div>
              ...
              <div class="svcServices" data-svc-services="registrations">
                ...
                <div class="svcItems">
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:0"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Startup India Registration</span><span class="svcItem__desc">Government-recognized startup benefits and incentives.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:1"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Trade License</span><span class="svcItem__desc">Legal permission to conduct business operations.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:2"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">FSSAI Registration</span><span class="svcItem__desc">Basic registration for food businesses.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:3"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">FSSAI License</span><span class="svcItem__desc">Mandatory licensing for larger food enterprises.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:4"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Halal License &amp; Certification</span><span class="svcItem__desc">Certification for halal-compliant products and services.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:5"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">ICEGATE Registration</span><span class="svcItem__desc">Required for customs and international trade activities.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:6"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Import Export Code (IEC)</span><span class="svcItem__desc">Mandatory for import and export businesses.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:7"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Legal Entity Identifier (LEI)</span><span class="svcItem__desc">Unique global identification for financial transactions.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:8"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">ISO Registration</span><span class="svcItem__desc">International quality certification standards.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:9"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">PF Registration</span><span class="svcItem__desc">Employee Provident Fund registration.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:10"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">ESI Registration</span><span class="svcItem__desc">Employee State Insurance registration.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:11"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Professional Tax Registration</span><span class="svcItem__desc">State-level employer tax compliance.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:12"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">RCMC Registration</span><span class="svcItem__desc">Export promotion council membership certificate.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:13"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">TN RERA Registration</span><span class="svcItem__desc">Mandatory registration for real estate agents.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:14"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">12A Registration</span><span class="svcItem__desc">Income tax exemption for NGOs.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:15"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">80G Registration</span><span class="svcItem__desc">Tax benefits for donors.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:16"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">12A &amp; 80G Registration</span><span class="svcItem__desc">Combined NGO tax exemption and donor benefit registration.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:17"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Barcode Registration</span><span class="svcItem__desc">Product barcode allocation and registration.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:18"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">BIS Registration</span><span class="svcItem__desc">Bureau of Indian Standards certification.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:19"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Certificate of Incumbency</span><span class="svcItem__desc">Verification of company status and directors.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:20"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">NGO Darpan Registration</span><span class="svcItem__desc">Government NGO recognition portal registration.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:21"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Digital Signature Certificate (DSC)</span><span class="svcItem__desc">Required for online filings and compliance.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:22"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Shop Act Registration</span><span class="svcItem__desc">Mandatory registration for shops and establishments.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:23"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Udyam Registration</span><span class="svcItem__desc">MSME registration with government benefits.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:24"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Fire License</span><span class="svcItem__desc">Fire safety compliance approval.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:25"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Food Testing</span><span class="svcItem__desc">Laboratory food safety testing and certification.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:26"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Water Testing</span><span class="svcItem__desc">Certified water quality testing services.</span></span><span class="svcItem__arr">→</span></a>
                </div>
              </div>
              ...
              <div class="svcServices" data-svc-services="trademark">
                ...
                <div class="svcItems">
                  <a class="svcItem" href="${base}services/accounting.html" style="--i:0"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Trademark Registration</span><span class="svcItem__desc">Protect your brand name and identity.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/accounting.html" style="--i:1"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Trademark Objection</span><span class="svcItem__desc">Professional response to trademark objections.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/accounting.html" style="--i:2"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Trademark Certificate</span><span class="svcItem__desc">Obtain trademark registration certificate.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/accounting.html" style="--i:3"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Trademark Opposition</span><span class="svcItem__desc">Support for opposition proceedings.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/accounting.html" style="--i:4"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Trademark Hearing</span><span class="svcItem__desc">Representation during trademark hearings.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/accounting.html" style="--i:5"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Trademark Rectification</span><span class="svcItem__desc">Correction of trademark records.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/accounting.html" style="--i:6"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Trademark Renewal</span><span class="svcItem__desc">Maintain trademark validity beyond 10 years.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/accounting.html" style="--i:7"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Trademark Transfer</span><span class="svcItem__desc">Transfer ownership of registered trademarks.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/accounting.html" style="--i:8"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Expedited Trademark Registration</span><span class="svcItem__desc">Fast-track trademark application processing.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/accounting.html" style="--i:9"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Logo Designing</span><span class="svcItem__desc">Professional logo and brand identity creation.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/accounting.html" style="--i:10"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Design Registration</span><span class="svcItem__desc">Protect product appearance and designs.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/accounting.html" style="--i:11"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Design Objection</span><span class="svcItem__desc">Response to design registration objections.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/accounting.html" style="--i:12"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Copyright Registration</span><span class="svcItem__desc">Protect creative works and content.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/accounting.html" style="--i:13"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Copyright Objection</span><span class="svcItem__desc">Handle copyright-related objections.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/accounting.html" style="--i:14"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Patent Registration</span><span class="svcItem__desc">Protect inventions and innovations.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/accounting.html" style="--i:15"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Trademark Protection</span><span class="svcItem__desc">Ongoing brand protection and monitoring services.</span></span><span class="svcItem__arr">→</span></a>
                </div>
              </div>
              ...
              <div class="svcServices" data-svc-services="compliance">
                ...
                <div class="svcItems">
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:0"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Company Annual Compliance</span><span class="svcItem__desc">Complete annual compliance for private limited companies.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:1"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">LLP Compliance</span><span class="svcItem__desc">Mandatory LLP annual filings and returns.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:2"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">OPC Compliance</span><span class="svcItem__desc">Compliance support for One Person Companies.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:3"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Company Name Change</span><span class="svcItem__desc">Official company name change process.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:4"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Registered Office Change</span><span class="svcItem__desc">Change company registered address.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:5"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">DIN eKYC Filing</span><span class="svcItem__desc">Director identity verification filing.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:6"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">DIN Reactivation</span><span class="svcItem__desc">Restore deactivated Director Identification Number.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:7"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Director Change</span><span class="svcItem__desc">Appointment and resignation of directors.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:8"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Remove Director</span><span class="svcItem__desc">Director removal ROC filing.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:9"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">ADT-1 Filing</span><span class="svcItem__desc">Auditor appointment filing with ROC.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:10"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">DPT-3 Filing</span><span class="svcItem__desc">Loan and deposit disclosure filing.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:11"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">LLP Form 11 Filing</span><span class="svcItem__desc">Annual LLP return filing.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:12"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Dormant Status Filing</span><span class="svcItem__desc">Apply for dormant company status.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:13"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">MOA Amendment</span><span class="svcItem__desc">Modify company objectives and clauses.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:14"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">AOA Amendment</span><span class="svcItem__desc">Amend internal governance rules.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:15"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Authorized Capital Increase</span><span class="svcItem__desc">Increase company authorised share capital.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:16"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Share Transfer</span><span class="svcItem__desc">Transfer company ownership shares.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:17"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Demat of Shares</span><span class="svcItem__desc">Share dematerialization services.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:18"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Winding Up – LLP</span><span class="svcItem__desc">LLP closure and strike-off process.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:19"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Winding Up – Company</span><span class="svcItem__desc">Company strike-off and closure.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:20"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Commencement (INC-20A)</span><span class="svcItem__desc">Business commencement declaration filing.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/tds-tcs.html" style="--i:21"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">CFSS Scheme</span><span class="svcItem__desc">Compliance support under applicable MCA schemes.</span></span><span class="svcItem__arr">→</span></a>
                </div>
              </div>
              ...
              <div class="svcServices" data-svc-services="businessSupport">
                ...
                <div class="svcItems">
                  <a class="svcItem" href="${base}services/statutory-audit.html" style="--i:0"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Business Plan</span><span class="svcItem__desc">Professional business plan preparation.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/statutory-audit.html" style="--i:1"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">HR &amp; Payroll</span><span class="svcItem__desc">Payroll management and HR support.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/statutory-audit.html" style="--i:2"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Bookkeeping</span><span class="svcItem__desc">Daily financial record maintenance.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/statutory-audit.html" style="--i:3"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">CA Support</span><span class="svcItem__desc">Dedicated chartered accountant assistance.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/statutory-audit.html" style="--i:4"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">PF Return Filing</span><span class="svcItem__desc">Employee provident fund return filing.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/statutory-audit.html" style="--i:5"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">ESI Return Filing</span><span class="svcItem__desc">Employee insurance return filing.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/statutory-audit.html" style="--i:6"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Professional Tax Return Filing</span><span class="svcItem__desc">State tax return compliance.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/statutory-audit.html" style="--i:7"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Partnership Compliance</span><span class="svcItem__desc">Ongoing compliance for partnerships.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/statutory-audit.html" style="--i:8"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Proprietorship Compliance</span><span class="svcItem__desc">Compliance support for proprietorship businesses.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:9"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">FSSAI Renewal</span><span class="svcItem__desc">Renew food licenses and registrations.</span></span><span class="svcItem__arr">→</span></a>
                  <a class="svcItem" href="${base}services/company-registration.html" style="--i:10"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">FSSAI Return Filing</span><span class="svcItem__desc">Mandatory FSSAI annual return compliance.</span></span><span class="svcItem__arr">→</span></a>
                </div>
              </div>
              ...
              <div class="svcServices" data-svc-services="audit">
                ...
                <div class="svcItems">
                  <a class="svcItem" href="${base}services/statutory-audit.html" style="--i:0"><span class="svcItem__dot"></span><span class="svcItem__body"><span class="svcItem__name">Audit &amp; Assurance</span><span class="svcItem__desc">Financial audits and assurance services.</span></span><span class="svcItem__arr">→</span></a>
                </div>
              </div>
    ...
    if (!document.getElementById('svcPanelStyles')) {
      ...
      style.textContent = `
        ...
        .svcPanel {
          ...
          border-top: 2px solid var(--color-saffron, #FF9933);
        ...
        .svcPanel__left::-webkit-scrollbar { display: none; }
        ...
        html[data-theme="dark"] .svcPanel__divider {
          background: rgba(255,255,255,0.06);
        }

        /* ── Category buttons ─── */
        .svcCats { display:flex; flex-direction:column; gap:1px; }
        ...
        html[data-theme="dark"] .svcCat { color: rgba(255,255,255,0.45); }
        ...
        html[data-theme="dark"] .svcCat.is-active,
        html[data-theme="dark"] .svcCat:hover {
          background: rgba(255,255,255,0.06);
        ...
        .svcCat.is-active::before {
          ...
          animation: svcCatLine 0.22s cubic-bezier(0.16,1,0.3,1) both;
        }
        ...
        .svcCat__num {
          ...
          color: rgba(255,153,51,0.35); min-width:16px; transition: color 0.18s;
        }
        ...
        html[data-theme="dark"] .svcCat__name { color: rgba(255,255,255,0.88); }
        .svcCat.is-active .svcCat__name,
        .svcCat:hover .svcCat__name { color: var(--color-saffron, #FF9933); }
        html[data-theme="dark"] .svcCat.is-active .svcCat__name,
        html[data-theme="dark"] .svcCat:hover .svcCat__name { color: #FF9933; }
        ...
        html[data-theme="dark"] .svcCat__hint { color: rgba(255,255,255,0.30); }
        .svcCat.is-active .svcCat__hint { color: var(--text-secondary, #666); }
        html[data-theme="dark"] .svcCat.is-active .svcCat__hint { color: rgba(255,255,255,0.48); }

        .svcCat__arr {
          font-size:0.9rem; opacity:0; transform:translateX(-4px);
          transition:all 0.18s ease; color:#FF9933; flex-shrink:0;
        }
        ...
        .svcPanel__right {
          ...
          scrollbar-color: rgba(255,153,51,0.20) transparent;
        }
        .svcPanel__right::-webkit-scrollbar { width: 3px; }
        .svcPanel__right::-webkit-scrollbar-track { background: transparent; }
        .svcPanel__right::-webkit-scrollbar-thumb {
          background: rgba(255,153,51,0.22); border-radius:4px;
        }
        ...
        html[data-theme="dark"] .svcServices__hd {
          background: #0c1829;
        ...
        .svcServices__title {
          ...
          color: var(--text, #111); letter-spacing: -0.01em;
        }
        html[data-theme="dark"] .svcServices__title { color: rgba(255,255,255,0.92); }

        .svcServices__count {
          font-size: 0.65rem; font-weight: 700;
          font-family: var(--font-mono, monospace);
          color: #FF9933; letter-spacing: 0.08em; text-transform: uppercase;
        ...
        .svcItem {
          ...
          opacity: 0;
          animation: svcItemIn 0.28s cubic-bezier(0.16,1,0.3,1) both;
        ...
        .svcItem:hover { background: rgba(255,153,51,0.07); }
        html[data-theme="dark"] .svcItem:hover { background: rgba(255,255,255,0.05); }
        .svcItem:hover .svcItem__arr { opacity:1; transform:translateX(0); }
        .svcItem:hover .svcItem__name { color:#FF9933; }

        .svcItem__dot {
          width:5px; height:5px; border-radius:50%;
          background:#FF9933; margin-top:6px;
        ...
        .svcItem__name {
          ...
          color: var(--text, #111); line-height: 1.25;
          transition: color 0.16s;
          white-space: nowrap; overflow:hidden; text-overflow:ellipsis;
        }
        html[data-theme="dark"] .svcItem__name { color: rgba(255,255,255,0.86); }
        ...
        html[data-theme="dark"] .svcItem__desc { color: rgba(255,255,255,0.35); }

        .svcItem__arr {
          font-size:0.82rem; color:#FF9933;
          opacity:0; transform:translateX(-4px);
          transition:all 0.16s ease; margin-top:4px; flex-shrink:0;
        }
        ...
        @media (max-width: 900px) {
          ...
          .svcPanel__left { padding:16px 16px 0; overflow-y:visible; height:auto; }
          .svcPanel__right { height:340px; }
  ...
  function initSvcPanel() {
    const serviceRoutes = {
      ...
      audit: "services/statutory-audit.html"
    };
